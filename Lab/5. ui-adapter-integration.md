...
The **newCustomer** function takes a **customer object**, sends it to the CustomerInfo adapter and creates a new customer in the Nodejs backend app.

Under the comment **"Add newCustomer code here"**, add the following code:
...
When the app is first launched, it will take you to the login screen.

Add the following code under the comment **"Add login code here"**.
